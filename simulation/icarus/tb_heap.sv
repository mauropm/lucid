...
module tb_heap;
    ...
    initial begin
        ...
        if (heap_free_ptr != 32'd296) fail_count++;
        ...
        $display("");
        if (fail_count == 0) begin $display("PASS: tb_heap"); $finish(0); end else begin $display("FAIL: tb_heap (%0d failures)", fail_count); $finish(1); end
    end
