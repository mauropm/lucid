...
// ========================
// Constants for message header encoding/decoding.
// Used by all FPU modules for inter-module communication.
//
// Header format (32-bit):
//   [31:24] DEST    Destination module ID
//   [23:16] SRC     Source module ID
//   [15:8]  TYPE    Message type
...
// Header field widths and offsets
parameter int HEADER_DEST_BITS  = 31;
...
// System message types (0x00-0x0F)
